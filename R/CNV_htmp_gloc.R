...
#'
#' @examples
#' CNV.mat1 <- utils::read.table(file="../Dataset/Sample_CNV_matrix.txt", header=TRUE, sep="\t")
#' CNV.mat <- CNV.mat1[,-1]
#' rownames(CNV.mat) <- CNV.mat1[,1]
#' breakGloc1 <- utils::read.table(file="../Dataset/Sample_breakGloc.txt", header=TRUE, sep="\t")
