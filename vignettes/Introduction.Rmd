...
```{r}
raw.data1 <- read.table( "../ins/extdata/Sample_20_CPCs__with__20_NPCs.txt", sep = '\t',header = TRUE) 
...
mito.genes1 <- read.table( "../ins/extdata/Sample_20_CPCs___Mitochondrial.txt", sep = '\t',header = TRUE)
